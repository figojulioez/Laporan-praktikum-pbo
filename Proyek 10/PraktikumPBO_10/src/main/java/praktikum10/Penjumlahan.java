...
/** Memmbuat kelas penjumlahan yang mengimplementasikan OperasiHitung
...
public class Penjumlahan implements OperasiHitung {
    /** Polimorfisme class penjumlahan pada method OperasiHitung karena definisinya tidak lengkap
